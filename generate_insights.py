...
def generate_insights(json_input):
    ...
    insights = text_generator(input_text, max_length=1023, truncation= True)
    return insights[0]["generated_text"]

if __name__ == "__main__":
    # Load your new JSON input
    json_input_path = "/Users/efecelik/PycharmProjects/json_decision_tree_to_insights/data/xxx.json"
    ...
    output_insights_path = "/Users/efecelik/PycharmProjects/json_decision_tree_to_insights/data/xxx_generated_insights.txt"
